...
Node {
    ...
    Texture {
        ...
        source: preload("maps/Tiles107_1K_Color.jpg")
    }
    Texture {
        id: tileNormal_texture
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: preload("maps/Tiles107_1K_NormalGL.jpg")
    }
    Texture {
        id: tileRoughness_texture
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: preload("maps/Tiles107_1K_Roughness.jpg")
    }
    ...
    Texture {
        ...
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: preload("maps/Tiles108_1K_Color.jpg")
    }
    ...
    Texture {
        ...
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: preload("maps/Tape001_1K_Color.jpg")
    }
    Texture {
        id: warningNormal_texture
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: preload("maps/Tape001_1K_NormalGL.jpg")
    }
    Texture {
        id: warningRoughness_texture
        generateMipmaps: true
        mipFilter: Texture.Linear
        source: preload("maps/Tape001_1K_Roughness.jpg")
    }
    ...
    StaticRigidBody {
        ...
        collisionShapes: TriangleMeshShape {
            source: preload("meshes/building.mesh")
        }
        Model {
            source: preload("meshes/building.mesh")
    ...
    ParticleSystem3D {
        ...
        SpriteParticle3D {
            id: spriteParticle
            sprite: Texture {
                source: preload("maps/sphere.png")
            }
            maxAmount: 10000
            color: "#aaccff"
