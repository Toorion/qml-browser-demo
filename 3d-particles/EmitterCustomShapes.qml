    ...
    View3D {
        ...
        ParticleSystem3D {
            ...
            SpriteParticle3D {
                id: particle3
                sprite: Texture {
                    source: preload("images/star3.png")
                }
                maxAmount: 1000
                color: "#40ffffff"
        ...
        ParticleSystem3D {
            ...
            SpriteParticle3D {
                ...
                maxAmount: 4096
                colorTable: Texture {
                    source: preload("images/color_table5.png")
                }
                color: "#d0ffffff"
            ...
            SpriteParticle3D {
                id: particle2
                sprite: Texture {
                    source: preload("images/dot.png")
                }
                maxAmount: 4096
                colorTable: Texture {
                    source: preload("images/color_table4.png")
                }
                color: "#60ffffff"
                colorVariation: Qt.vector4d(0.0, 0.0, 0.0, 0.4)
                particleScale: 6.0
            ...
            ParticleEmitter3D {
                ...
                shape: ParticleCustomShape3D {
                    source: preload("data/qt_logo_in_4096.cbor")
                }
                lifeSpan: 5001
                emitBursts: [
                    EmitBurst3D {
            ...
            ParticleEmitter3D {
                ...
                scale: Qt.vector3d(5.0, 5.0, 5.0)
                shape: ParticleCustomShape3D {
                    source: preload("data/qt_logo_out_4096.cbor")
                }
                lifeSpan: 5001
                emitBursts: [
                    EmitBurst3D {
            ...
            Attractor3D {
                ...
                shape: ParticleCustomShape3D {
                    source: preload("data/heart_4096.cbor")
                    randomizeData: true
                }
                duration: 4000
