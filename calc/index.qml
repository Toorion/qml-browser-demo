...
Item {
    ...
    property string title: "Calculator Example"
    
    property string stateSource: preload("statemachine.scxml") 
    ...
    EventConnection {
        stateMachine: scxmlLoader.stateMachine
    ...
    Item {
        ...
        Repeater {
            ...
            Button {
                ...
                text: modelData
                fontHeight: 0.4
                onClicked: scxmlLoader.stateMachine.submitEvent(eventName)
        ...
        Button {
            ...
            text: "="
            onClicked: scxmlLoader.stateMachine.submitEvent("EQUALS")
        }
    }
