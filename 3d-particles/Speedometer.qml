...
Item {
    ...
    View3D {
        ...
        Node {
            ...
            Model {
                y: -4 - separation * 100
                source: preload("meshes/meter_background.mesh")
                ...
                materials: PrincipledMaterial {
                    ...
                    roughness: 0.6
                    normalMap: Texture {
                        source: preload("images/leather_n.png")
                    }
                    normalStrength: 0.4
                }
            }
            ...
            Model {
                ...
                materials: PrincipledMaterial {
                    ...
                    baseColorMap: Texture {
                        source: preload("images/speedometer_labels.png")
                    }
                }
            }
            ...
            Model {
                y: separation * 60
                source: preload("meshes/meter_edge.mesh")
                scale: Qt.vector3d(30, 30, 30)
                materials: PrincipledMaterial {
                    baseColor: "#b0b0b0"
                }
