    ...
    View3D {
        ...
        Component {
            ...
            Model {
                ...
                materials: DefaultMaterial {
                    diffuseMap: Texture { source: preload("images/smoke.png") }
                    lighting: DefaultMaterial.NoLighting
                }
                opacity: 0.2
            }
        ...
        Component {
            ...
            Model {
                ...
                materials: DefaultMaterial {
                    diffuseMap: Texture { source: preload("images/star.png") }
                    lighting: DefaultMaterial.NoLighting
        ...
        Node {
            ...
            Model {
                ...
                opacity: 0
                materials: DefaultMaterial {
                    diffuseMap: Texture { source: preload("images/qt_logo.png") }
                }
            }
    ...
    Frame {
        ...
        RowLayout {
            ...
            Button {
                ...
                icon.source: timelineAnimation.running ? preload("images/icon_pause.png") : preload("images/icon_play.png")
