...
Rectangle {
    ...
    height: 720
    visible: true
    property string title: "Qt Quick 3D Physics - Custom Shapes"
    ...
    View3D {
        ...
        Texture {
            id: numberNormal
            source: preload("maps/numbers-normal.png")
        }

        Texture {
            id: numberFill
            source: preload("maps/numbers.png")
            generateMipmaps: true
            mipFilter: Texture.Linear
        }
        //! [textures]
        ...
        Node {
            ...
            StaticRigidBody {
                ...
                Model {
                    geometry: HeightFieldGeometry {
                        ...
                        source: preload("maps/cloth-heightmap.png")
                        smoothShading: false
                    }
            ...
            DynamicRigidBody {
                ...
                collisionShapes: TriangleMeshShape {
                    id: cupShape
                    source: preload("meshes/simpleCup.mesh")
                }
                Model {
                    source: preload("meshes/cup.mesh")
                    materials: PrincipledMaterial {
                        baseColor: "#cc9988"
                        roughness: 0.3
                        metalness: 1
            ...
            StaticRigidBody {
                ...
                Model {
                    id: testModel
                    source: preload("meshes/tower.mesh")
                    materials: [
                        PrincipledMaterial {
                            baseColor: "#ccccce"
                            roughness: 0.3
            ...
            Component {
                ...
                DynamicRigidBody {
                    ...
                    collisionShapes: ConvexMeshShape {
                        property string h1: preload("meshes/icosahedron.mesh")
                        property string h2: preload("meshes/dodecahedron.mesh")
                        property string h3: preload("meshes/octahedron.mesh")
                        property string h4: preload("meshes/tetrahedron.mesh")
                        id: diceShape
                        source: Math.random() < 0.25 ? h1
                              : Math.random() < 0.5 ? h2
                              : Math.random() < 0.75 ? h3
                                                     : h4
                    }
