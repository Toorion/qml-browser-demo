...
Rectangle {
    ...
    property int acc: 0
    property string title: 'Same Game'
    ...
    Image {
        source: preload("gfx/background.png")
        anchors.fill: parent
    }
    ...
    Item {
        ...
        Row {
            x: 112
            y: 20
            Image { source: preload("gfx/logo-a.png") }
            Image { source: preload("gfx/logo-m.png") }
            Image { source: preload("gfx/logo-e.png") }
        }
        ...
        Column {
            ...
            Button {
                width: root.width
                rotatedButton: true
                imgSrc: Qt.resolvedUrl("gfx/but-game-1.png")
                onClicked: {
            ...
            Button {
                width: root.width
                rotatedButton: true
                imgSrc: Qt.resolvedUrl("gfx/but-game-2.png")
                onClicked: {
                    if (root.state == "in-game")
                        return
                    root.state = "in-game"
            ...
            Button {
                width: root.width
                rotatedButton: true
                imgSrc: Qt.resolvedUrl("gfx/but-game-3.png")
                onClicked: {
                    if (root.state == "in-game")
                        return
                    root.state = "in-game"
            ...
            Button {
                width: root.width
                rotatedButton: true
                imgSrc: Qt.resolvedUrl("gfx/but-game-4.png")
                group: "yellow"
                onClicked: {
                    if (root.state == "in-game")
                        return
    ...
    Image {
        ...
        Button {
            ...
            imgSrc: Qt.resolvedUrl("gfx/but-quit.png")
            onClicked: {Qt.quit(); }
        ...
        Button {
            id: menuButton
            height: Settings.toolButtonHeight
            imgSrc: Qt.resolvedUrl("gfx/but-menu.png")
        ...
        Button {
            id: againButton
            height: Settings.toolButtonHeight
            imgSrc: Qt.resolvedUrl("gfx/but-game-new.png")
            visible: (root.state == "in-game");
        ...
        Button {
            id: nextButton
            height: Settings.toolButtonHeight
            imgSrc: Qt.resolvedUrl("gfx/but-puzzle-next.png")
